import { EventStore, EventStoreEventDetails, EventStoreId } from '@hamstore/core';
...
export type EventStoresReduxState<EVENT_STORES extends EventStore[] = EventStore[]> =
    ...
    : EVENT_STORES extends [infer HEAD_EVENT_STORE, ...infer TAIL_EVENT_STORES]
      ? HEAD_EVENT_STORE extends EventStore
        ? TAIL_EVENT_STORES extends EventStore[]
          ? Record<EventStoreId<HEAD_EVENT_STORE>, EventStoreReduxState<HEAD_EVENT_STORE>> &
              EventStoresReduxState<TAIL_EVENT_STORES>
          : never
        : never
      : unknown;

export type EventStoreReduxReducer<EVENT_STORE extends EventStore = EventStore> = Reducer<
  EventStoreReduxState<EVENT_STORE>
>;
