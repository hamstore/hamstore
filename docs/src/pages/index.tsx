  ...
  <>
        ...
        <div className="flex gap-2 lg:gap-4 items-center">
          <div className="w-[40px] md:w-[60px] lg:w-[100px]">
            ...
            >
              ...
              <path
                fill="#47193A"
                d="M417.8,0.1c235.2-4.5,429.6,182.5,434.1,417.8c4.5,235.2-182.5,429.6-417.8,434.1S4.6,669.4,0.1,434.1
	C-4.4,198.9,182.6,4.6,417.8,0.1"
              />
              <path
                fill="#B7622F"
                d="M723,567.9c23.8,53.1,5.2,98.2-10.3,118.6l-15.5,32c-1.6,3,2.3,5.9,4.8,3.6c169-157.6,172.7-426,4.7-587.7
	...
	c-0.9,1.9,0.4,4.1,2.5,4.3c35.8,3.4,34.6,89.6,16.8,112.1C722.7,565.6,722.6,566.8,723,567.9"
              ...
              <path
                ...
                clipRule="evenodd"
                fill="#83432A"
                d="M723,567.9c23.8,53.1,5.2,98.2-10.3,118.6l-15.5,32
	...
	c-0.9,1.9,0.4,4.1,2.5,4.3c35.8,3.4,34.6,89.6,16.8,112.1C722.7,565.6,722.6,566.8,723,567.9"
              ...
              <path
                ...
                clipRule="evenodd"
                fill="#83432A"
                d="M53.8,272.2c0.9,0.8,2.3,1,3.6,0.2c0.6-0.4,1.2-0.8,1.9-1.2
	c66.7-40.6,164.6,21.2,202.5,115.5c1.1,2.8,5.2,2.4,5.8-0.5c7.6-36.3,19.4-74.1,32.9-105.9h0C129.2,191.7,53.8,272.2,53.8,272.2"
              ...
              <path
                fill="#F07C34"
                d="M362.5,181c-19-14.7-42.8-13.6-37.6,9.5c1.6,7,5.7,14,11.2,20c1.3,1.4,3.5,1.3,4.6-0.2
	c6.9-8.9,14.3-17.1,22-24.7C364.1,184.3,364,182.1,362.5,181"
              />
              <path
                fill="#D46D31"
                d="M362.5,181c-19-14.7-42.8-13.6-37.6,9.5c0.1,0.4,0.2,0.7,0.3,1.1c10.7-15.8,38.5-8.3,38.5-8.3
	C363.6,182.4,363.2,181.6,362.5,181"
              />
              <path
                fill="#F07C34"
                d="M670,203.1c25.1-31.1,1-51.2-27.4-28.2c-1.5,1.2-1.5,3.4-0.1,4.6c8.3,7.3,15.9,15.2,22.8,23.6
	C666.6,204.7,668.8,204.6,670,203.1"
              />
              <path
                fill="#D46D31"
                d="M680.5,180.7c1.1-16.4-17.3-22.4-37.9-5.8c-0.7,0.6-1.1,1.4-1.1,2.3C641.5,177.2,671.9,166.5,680.5,180.7"
              />
              <path
                fill="#F07C34"
                d="M236.6,380.9C178.9,260,15.7,214.7,21.4,436.5C25.5,597.7,125,740.7,273.4,801c2.3,0.9,4.7-1.2,4.1-3.6
	c-20.6-78-28.8-165-27.1-248.6C251.8,481.7,267,444.7,236.6,380.9"
              />
              <path
                fill="#967244"
                d="M707.5,473.7c-8.5,0.2-5.9,77.5,1.5,77.4C718,550.9,717.4,473.6,707.5,473.7"
              />
              <path
                fill="#856438"
                d="M705.5,475.4c-5.5,10-3.8,63.1,1.5,73.8C712.9,538.3,712.4,485.1,705.5,475.4"
              />
              <path
                fill="#967244"
                d="M341,483.1c-10.2,0.2-8.5,101.3,1.9,101.1C351.9,584,350.2,483,341,483.1"
              />
              <path
                fill="#856438"
                d="M345.7,580.2c4.9-16.3,3.9-77.1-1.7-93.1C338.3,503.3,339.4,564.1,345.7,580.2"
              />
              <path
                fill="#FFFFFF"
                d="M517.3,516.9l3.3,20.6c0.2,1.5,1.5,2.5,3,2.5l19.5,0c1.4,0,2.5-0.9,2.9-2.2l6.3-21.2c0.5-1.6-0.4-3.2-2-3.7
	c-20.4-6.6-5.8-5.9-30.8,0.6C518,513.8,517.1,515.3,517.3,516.9"
              />
              <path
                fill="#E6E6E6"
                d="M517.3,516.9l0.2,1.2c0,0,20.8-5.6,34,1l0.7-2.5c0.5-1.6-0.4-3.2-2-3.7c-20.4-6.6-5.8-5.9-30.8,0.6
	C518,513.8,517.1,515.3,517.3,516.9"
              />
              <path
                fill="#F07C34"
                d="M677.2,630.1c-38.5,1.1-106.2,20.5-104.4,61.4c1.9,41.1,103.1,24.6,131.2-30.8c6.9-13.6,9.9-27.9,9.6-42.4
	...
	C683.6,620,683.8,629.9,677.2,630.1"
              ...
              <path
                fill="#D46D31"
                d="M280.3,685.7c-1.2,0.5-2.1,1.6-2,3.2c5.1,41.5,13.3,82.5,24.8,121.4c0.3,1,1,1.7,2,2
	c82,25.6,208.5,22,292-22C327.3,852.8,280.3,685.7,280.3,685.7"
              />
              <path
                fill="#D46D31"
                d="M573.1,685.5c-0.2,1.9-0.3,3.9-0.2,6c1.9,41.1,103.1,24.6,131.2-30.8c6.9-13.6,9.9-27.9,9.6-42.4
	c0-1.1-0.6-2-1.4-2.5C714.2,681.5,595.7,723,573.1,685.5"
              />
              <path
                fill="#D46D31"
                d="M274.7,489c-1.9,24.2-2.9,49.1-3.1,74.6c0,5.4,0,10.8,0,16.2c0,0.1,0,0.1,0,0.2
	c14.7,194.2,206,162.7,198.5,121.3c-0.3-1.9-0.8-3.7-1.4-5.6c-1.1-2.6-2.4-5.4-3.9-8.3l0,0C466.6,740,260.5,743.4,274.7,489"
              />
              <path
                fill="#F9A11C"
                d="M427.9,481.7c14.7,10.5,33.1,16.6,55.4,15.9c12.9-0.4,27.1-2.9,42.6-8.1l2.1-2.5c4.3-33.5,9.2-81,10.4-93.1
	...
	c38.2-20.8,11.4-92.9-41.6-98.4l-35-3.4c0,0-32.9-1.7-66.1-1.7C442.3,385.8,384.4,451.5,427.9,481.7"
              ...
              <path
                fill="#47193A"
                d="M547.1,364.5c29.5,2.3,53.5,12,52.1,30.2c-1.4,18.2-27.3,42.6-56.9,40.3c-29.5-2.3-51.4-30.4-50-48.6
	C493.7,368.3,517.6,362.2,547.1,364.5"
              />
              <path
                fill="#47193A"
                d="M462,278.1c12.8-0.2,23.4,9.9,23.6,22.8c0.2,12.8-9.9,23.4-22.8,23.6c-12.8,0.2-23.4-9.9-23.6-22.8
	C439,288.9,449.2,278.3,462,278.1"
              />
              <path
                fill="#47193A"
                d="M627.2,287.5c12.8-0.2,23.4,9.9,23.6,22.8c0.2,12.8-9.9,23.4-22.8,23.6c-12.8,0.2-23.4-9.9-23.6-22.8
	C604.2,298.3,614.4,287.8,627.2,287.5"
              />
              <path
                fill="#967244"
                d="M569.7,563.8l94.4-8.6l0-0.1l19.6-1.8c3.8-0.3,3.6-6-0.2-6.2l-81.5-3.1c-3.6-0.1-2.9-4.5-3-7.9
	...
	C566.9,565.3,568.1,563.9,569.7,563.8"
              ...
              <path
                fill="#856438"
                d="M627.4,558.5l36.7-3.4l0-0.1l19.6-1.8c3.8-0.3,3.6-6-0.2-6.2l-81.5-3.1c-3.6-0.1-2.9-4.5-3-7.9
	c0-1.6,1.2-3,2.8-3.1l76.6-6.1c3.6-0.3,2.7-4.3,2.5-6.1c-0.1-1.6-1.5-2.8-3.1-2.8l-58.5,1.2c-13.1,2.3-27.5,2.4-43-0.1
	c-1.5-0.2-3,0.7-3.4,2.1l-0.1,0.3C580.8,531.3,596.6,545.6,627.4,558.5"
              />
              <path
                fill="#856438"
                d="M587.5,582.3L587.5,582.3L587.5,582.3L587.5,582.3z M475.7,560.2l-106,7.5c-1.4,0.1-2.4,1-2.7,2.4
	...
	c0.1,1.5,1.3,2.7,2.8,2.8l46.9,3.5C412.2,519.9,406.8,514.5,402.4,509.4z"
              ...
              <path
                fill="#F9A11C"
                d="M635.3,607.9c-70.3-8.1-138.3-7.6-201.3-5.6c-5.2,12.6-9.5,26.3-12.5,41c32.2,8,61.2,25.1,66.9,56
	...
	c-49.9,21.2-108.2,13.6-110.2-31.4c-1.9-41.3,49.3-60.3,91.6-67.9C640.8,618.7,638.1,613.2,635.3,607.9"
              ...
              <path
                fill="#EE921C"
                d="M430.7,799.8c3.2,9.8,6.8,19.2,10.7,28.1c55.3-2.3,111.5-14.3,155.7-37.6
	C528.1,806.4,473.6,807.3,430.7,799.8"
              />
              <path
                fill="#7A4D6C"
                d="M536,378c2.8-12.5,55-2.8,50.6,10.7C584.4,395.3,533.5,389.1,536,378"
              />
              <path
                fill="#D46D31"
                d="M180.6,644.4c5.3-9.4,11.1-19.3,17.2-29.5c9.9,4.6,20.1,9.5,30.6,14.6c-6.2,10.3-11.9,20.1-17.2,29.5
	...
	C25,401.8,23.3,404.4,21.7,406.9z"
              ...
              <path
                display="none"
                fill="#47193A"
                d="M847.4,942.2h4.4v43.9H835c-12.5,0-18.7,6.7-18.7,20.2v85.4h-50.4v-148h49.5v22.8
	...
	C77.4,1057.6,79.8,1055.4,79.8,1051.1z M79.8,972.8v-30.8c0-4.3-2.5-6.5-7.4-6.5H51.1v43.9h21.3C77.4,979.3,79.8,977.1,79.8,972.8z"
              ...
              <path
                display="none"
                fill="#47193A"
                d="M702.7,1149.7v-7.1H717v-5.5h-14.3v-6.7h16.2v-5.7h-23.3v30.8h23.8v-5.7H702.7z
