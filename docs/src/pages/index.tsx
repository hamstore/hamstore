...
import { FaRegCopy, FaGithub, FaPuzzlePiece, FaHandHoldingHeart } from 'react-icons/fa';
      ...
      <div className="flex flex-col gap-12 md:gap-16">
        ...
        <div className="flex flex-col items-center gap-3 text-center px-4">
          <div className="flex gap-2 lg:gap-4 items-center">
            <div className="w-[40px] md:w-[60px] lg:w-[100px]">
              <img src={logoUrl} alt="Hamstore Logo" className="w-full h-auto" />
            </div>
          ...
          <p className="text opacity-90 max-w-[500px] lg:text-xl lg:max-w-[600px]">
            ...
            is a data storage paradigm that saves <strong>changes in your application state</strong>{' '}
            rather than the state itself.
          </p>
          <p className="text opacity-90 max-w-[500px] lg:text-xl lg:max-w-[600px]">
            It is powerful as it enables <strong>rewinding to a previous state</strong> and{' '}
            <strong>exploring audit trails</strong> for debugging or business/legal purposes. It
        ...
        <div className="text-lg flex flex-col gap-12 p-8 max-w-[1200px] mx-auto md:flex-row">
          <div className="flex-1 flex flex-col gap-8 items-center max-w-[400px]">
            ...
            <div className="flex flex-col gap-1 text-center">
              ...
              <p className="text-sm dark:text-gray-200 leading-6">
                Hamstore is in <strong>TypeScript</strong>. Outside from that, it can be used pretty
                much <strong>anywhere</strong>: Web apps, containers, Lambdas... you name it 🙌
              </p>
              <p className="text-sm dark:text-gray-200 leading-6">
                For instance, <code>EventStore</code> classes are <strong>stack agnostic</strong>:
                They need an <code>EventStorageAdapter</code> class to interact with actual data.
              </p>
              <p className="text-sm dark:text-gray-200 leading-6">
                You can code your own <code>EventStorageAdapter</code> (simply implement the
                interface), but it's much simpler to use off-the-shelf adapters like the{' '}
          ...
          <div className="flex-1 flex flex-col gap-8 items-center max-w-[400px]">
            ...
            <div className="flex flex-col gap-1 text-center">
              <h3 className="uppercase text-center text-xl font-black">Modular & Type-safe</h3>
              <p className="text-sm dark:text-gray-200 leading-6">
                Hamstore is a <strong>collection of utility classes and helpers</strong>, but NOT a
                framework: While some classes require compatible infrastructure, Hamstore is not
                responsible for deploying it.
              </p>
              <p className="text-sm dark:text-gray-200 leading-6">
                Though that is not something we exclude in the future, we are a small team and
                decided to focus on DevX first.
              </p>
              <p className="text-sm dark:text-gray-200 leading-6">
                Speaking of DevX, we absolutely love TypeScript! If you do too, you're in the right
                place: We <strong>push type-safety to the limit</strong> in everything we do!
              </p>
            </div>
          </div>
          <div className="flex-1 flex flex-col gap-8 items-center max-w-[400px]">
            ...
            <div className="flex flex-col gap-1 text-center">
              <h3 className="uppercase text-center text-xl font-black">Comprehensive</h3>
              <p className="text-sm dark:text-gray-200 leading-6">
                The Event Sourcing journey has many hidden pitfalls.{' '}
                <strong>We ran into them for you</strong>!
              </p>
              <p className="text-sm dark:text-gray-200 leading-6">
                Hamstore is opinionated. It comes with a collection of best practices and documented
                anti-patterns that we hope will help you out!
              </p>
              <p className="text-sm dark:text-gray-200 leading-6">
                It also comes with an awesome collection of packages that will make your life easy,
                e.g. when working on{' '}
                <a href="https://www.npmjs.com/package/@hamstore/lib-test-tools">unit tests</a>,{' '}
                <a href="https://www.npmjs.com/package/@hamstore/lib-dam">data migration</a> or{' '}
      ...
      <div className="navbar navbar--dark flex flex-col items-start justify-center py-10 text-sm shadow-xl shadow-black/10">
        <div className="full-width">
          ...
          <div className="text-center opacity-20 mt-2">
            &copy; 2022-2025 Serverless by Theodo, {new Date().getFullYear()} Geostrategists
          </div>
        </div>
      </div>
    </>
